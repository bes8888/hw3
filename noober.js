...
//  set level of service based on various criteria
...
// always assign info for the first passenger
...
// if there's a 2nd passenger, assign info
if (ride.length > 1) {
  ...
  // nested if to assign info for 3rd passenger if there is one
  if (ride.length > 2) {
